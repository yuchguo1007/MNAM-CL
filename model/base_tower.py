...
from preprocessing.inputs import SparseFeat, DenseFeat, create_embedding_matrix, build_input_features
...
class BaseTower(nn.Module):
    ...
    def embedding_size(self):
        ...
        if len(embedding_size_set) > 1:
            raise ValueError("embedding_dim of SparseFeat must be same in this model!")
