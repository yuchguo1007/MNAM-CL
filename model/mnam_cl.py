...
class MNAM_CL(BaseTower):
    def __init__(self, user_dnn_feature_columns, item_dnn_feature_columns, fair_expert_dnn_feature_columns, protected_field,
                 use_cl_loss=True, temperature=0.1, dnn_use_bn=True, dnn_hidden_units=(300, 300, 128), fair_expert_hidden_units=(), dnn_activation='relu', l2_reg_dnn=0, l2_reg_embedding=1e-6,
